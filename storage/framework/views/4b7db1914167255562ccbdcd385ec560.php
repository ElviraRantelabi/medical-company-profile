	...
	<section class="custom-banner">
		<div class="container">
			<div class="banner-content">
				<h4>Trusted Medical Equipment Supplier</h4>
				<h1>High Quality Medical Devices for Hospitals & Clinics</h1>
				<p>
					Discover certified and reliable medical equipment designed 
					to support healthcare professionals with safety and precision.
				</p>
				<a href="<?php echo e(url('/catalog')); ?>" class="banner-btn">
					View Catalog
				</a>
			</div>
		</div>
				...
				<div class="col-lg-12">
					<div class="section-title text-center wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1s">
						...
						<div class="section-main-title">
							<h2>Amazing Medical Services</h2>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="service-single-box wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1s">
						...
						<div class="service-content">
							<h4><a href="service-details.html"> Medical Equipment Supply</a></h4>
							<p>Providing certified and reliable devices.</p>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-single-box wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1s">
						...
						<div class="service-content">
							<h4><a href="service-details.html"> Installation & Maintenance</a></h4>
							<p>Professional setup and after-sales service.</p>
						</div>
						<div class="Lifesafe-btn service">
							<a href="#">Read More +</a>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="service-single-box wow fadeInUp" data-wow-delay="0.8s" data-wow-duration="1s">
						...
						<div class="service-content">
							<h4><a href="service-details.html"> Fast Distribution</a></h4>
							<p>Nationwide delivery with secure packaging.</p>
						</div>
						<div class="Lifesafe-btn service">
							<a href="#">Read More +</a>
						</div>
					...
					<div class="row choose">
						<div class="col-lg-6 col-md-12">
							<div class="choose-list wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1s">
								<span><i class="bi bi-chevron-double-right"></i> International Certification</span>
								<span><i class="bi bi-chevron-double-right"></i> Experienced Technical Team</span>
							</div>
						</div>
						<div class="col-lg-6 col-md-12">
							<div class="choose-list wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1s">
								<span><i class="bi bi-chevron-double-right"></i> 24/7 Customer Support</span>
								<span><i class="bi bi-chevron-double-right"></i> Trusted by Hospitals & Clinics</span>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="section-title text-center wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1s">
						...
						<div class="section-main-title">
							<h2>Ready to Partner With a Trusted Medical Equipment Provider?</h2>
						</div>
					</div>
				</div>
			</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/elvirarantelabi/medical-company-profile/resources/views/home.blade.php ENDPATH**/ ?>