...
<!-- Dropdown Row -->
<div class="row mt-3 mb-5"> <!-- mb-5 untuk jarak bawah -->
...
<div class="col-lg-4 col-md-6">
    <div class="service-single-box wow fadeInUp">
        <div class="service-thumb">
            <img src="<?php echo e(asset('assets/images/service/service1.png')); ?>" alt="">
            <div class="service-icon">
                <img src="<?php echo e(asset('assets/images/service/service-icon1.png')); ?>" alt="">
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/elvirarantelabi/medical-company-profile/resources/views/catalog.blade.php ENDPATH**/ ?>